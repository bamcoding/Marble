 ...
 *
 */
public class SoundStreamingUtil {
	...
	private static SoundStreamingUtil downloadUtil;
	
	private SoundStreamingUtil() {}
	 ...
	 * @return
	 */
	public static SoundStreamingUtil getInstance(String filePath) {
		
		if ( downloadUtil == null ) {
			downloadUtil = new SoundStreamingUtil();
		}
