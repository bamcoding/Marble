	...
	public List<CategoryVO> getCategory(CategoryVO categoryVO) {
		return selectList(new QueryAndResult() {
			...
			public PreparedStatement query(Connection conn) throws SQLException {
				...
				query.append(" AND		CTGR_ID NOT IN (SELECT CTGR_ID FROM CTGR WHERE CTGR_NM = '»≤±›ø≠ºË') ");
	...
	public List<GamesVO> allGetGames() {
		return selectList(new QueryAndResult() {
			...
			public PreparedStatement query(Connection conn) throws SQLException {
				...
				query.append(" WHERE	G.CTGR_ID = C.CTGR_ID ");
				query.append(" AND		G.TYP_ID = T.TYP_ID ");
				query.append(" AND		G.TYP_ID NOT IN (SELECT TYP_ID FROM GAME_TYPE WHERE TYP_NM = '»≤±›ø≠ºË' AND TYP_NM = '≥ª∞‘¿”') ");
	...
	public List<GamesVO> getGoldenCards() {
		return selectList(new QueryAndResult() {
			...
			public PreparedStatement query(Connection conn) throws SQLException {
				...
				query.append(" WHERE	G.CTGR_ID = C.CTGR_ID ");
				query.append(" AND		G.TYP_ID = T.TYP_ID ");
				query.append(" AND		G.TYP_ID = (SELECT TYP_ID FROM GAME_TYPE WHERE TYP_NM = '»≤±›ø≠ºË') ");
